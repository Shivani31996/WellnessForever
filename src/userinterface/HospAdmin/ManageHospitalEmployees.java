...
public class ManageHospitalEmployees extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(btnAddEmployee, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 600, 110, 40));
        ...
        btnDeleteEmployee.setkBackGroundColor(new java.awt.Color(204, 0, 51));
        btnDeleteEmployee.setkEndColor(new java.awt.Color(204, 0, 51));
        btnDeleteEmployee.setkHoverEndColor(new java.awt.Color(204, 0, 51));
        btnDeleteEmployee.setkHoverForeGround(new java.awt.Color(204, 0, 51));
        btnDeleteEmployee.setkHoverStartColor(new java.awt.Color(0, 0, 0));
        btnDeleteEmployee.setkSelectedColor(new java.awt.Color(204, 0, 51));
        btnDeleteEmployee.setkStartColor(new java.awt.Color(204, 0, 51));
        btnDeleteEmployee.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnDeleteEmployeeActionPerformed(evt);
            }
        });
        add(btnDeleteEmployee, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 310, 140, 40));

        btnUpdateEmployee.setText("Update Employee");
        btnUpdateEmployee.setkBackGroundColor(new java.awt.Color(204, 0, 51));
        btnUpdateEmployee.setkEndColor(new java.awt.Color(204, 0, 51));
        btnUpdateEmployee.setkHoverEndColor(new java.awt.Color(204, 0, 51));
        btnUpdateEmployee.setkHoverForeGround(new java.awt.Color(204, 0, 51));
        btnUpdateEmployee.setkHoverStartColor(new java.awt.Color(0, 0, 0));
        btnUpdateEmployee.setkSelectedColor(new java.awt.Color(204, 0, 51));
        btnUpdateEmployee.setkStartColor(new java.awt.Color(204, 0, 51));
        btnUpdateEmployee.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnUpdateEmployeeActionPerformed(evt);
            }
        });
        add(btnUpdateEmployee, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 360, 140, 40));
