...
public class ManageEnterpriseAdminJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 500, -1, -1));

        jLabel1.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        jLabel1.setText("Enterprise Name:");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 320, -1, 20));

        kButton1.setText("Add Employee");
        kButton1.setkBackGroundColor(new java.awt.Color(204, 0, 51));
        kButton1.setkEndColor(new java.awt.Color(204, 0, 51));
        kButton1.setkHoverEndColor(new java.awt.Color(204, 0, 51));
        kButton1.setkHoverForeGround(new java.awt.Color(204, 0, 51));
        ...
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 380, -1, -1));

        adminTxtUserName.setBorder(null);
        add(adminTxtUserName, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 440, 370, 30));
        add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 470, 370, -1));
        add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 530, 370, -1));

        adminTxtPassword.setBorder(null);
        add(adminTxtPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 500, 370, 30));

        jLabel5.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        jLabel5.setText("Username:");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 440, -1, -1));

        adminTxtName.setBorder(null);
        add(adminTxtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 380, 370, 30));
        add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 410, 370, -1));
        ...
        add(cmbBoxEnterpriseList, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 320, 370, -1));

        jLabel6.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        jLabel6.setText("Network:");
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 260, -1, 20));
        ...
        add(networkCmbBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 260, 370, -1));
    ...
    private void kButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton1ActionPerformed
        ...
        try {
            ...
            {                
                ...
                if(employee == null)
                {
                    JOptionPane.showMessageDialog(null, "Employee " + adminTxtName.getText() + " already exists!","Warning",JOptionPane.WARNING_MESSAGE);
                    return;
                }
                else
                {
