...
public class BookAnAppointmentPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnBookAppointment.setkBackGroundColor(new java.awt.Color(204, 0, 51));
        btnBookAppointment.setkEndColor(new java.awt.Color(204, 0, 51));
        btnBookAppointment.setkHoverEndColor(new java.awt.Color(204, 0, 51));
        btnBookAppointment.setkHoverForeGround(new java.awt.Color(204, 0, 51));
        btnBookAppointment.setkHoverStartColor(new java.awt.Color(0, 0, 0));
        btnBookAppointment.setkSelectedColor(new java.awt.Color(204, 0, 51));
        btnBookAppointment.setkStartColor(new java.awt.Color(204, 0, 51));
