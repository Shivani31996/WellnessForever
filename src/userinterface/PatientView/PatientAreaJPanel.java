...
public class PatientAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        panelSelectionBg5 = new javax.swing.JPanel();
        ...
        panelSelectionBg5.setBackground(new java.awt.Color(51, 51, 51));

        lblDonateBlood.setFont(new java.awt.Font("Lucida Grande", 1, 20)); // NOI18N
        lblDonateBlood.setForeground(new java.awt.Color(204, 0, 51));
        lblDonateBlood.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        lblDonateBlood.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/BookAnAppt.png"))); // NOI18N
        lblDonateBlood.setText("Donate Blood");
        lblDonateBlood.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lblDonateBloodMouseClicked(evt);
            }
            public void mousePressed(java.awt.event.MouseEvent evt) {
                lblDonateBloodMousePressed(evt);
            }
        });

        javax.swing.GroupLayout panelSelectionBg5Layout = new javax.swing.GroupLayout(panelSelectionBg5);
        panelSelectionBg5.setLayout(panelSelectionBg5Layout);
        panelSelectionBg5Layout.setHorizontalGroup(
            panelSelectionBg5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelSelectionBg5Layout.createSequentialGroup()
                .addGap(0, 15, Short.MAX_VALUE)
                .addComponent(lblDonateBlood, javax.swing.GroupLayout.PREFERRED_SIZE, 275, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        panelSelectionBg5Layout.setVerticalGroup(
            panelSelectionBg5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(panelSelectionBg5Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lblDonateBlood)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        PatientMenuPanel.add(panelSelectionBg5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 210, 290, 50));
    ...
    private void lblDonateBloodMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblDonateBloodMousePressed
        // TODO add your handling code here:
        setStyleDonateBlood();
        PatientWorkAreaContainer.removeAll();
        DonateBloodPanel dB = new DonateBloodPanel(PatientWorkAreaContainer,system,user);
        PatientWorkAreaContainer.add("DonateBlood",dB);
    }//GEN-LAST:event_lblDonateBloodMousePressed

    private void lblDonateBloodMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblDonateBloodMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_lblDonateBloodMouseClicked
    ...
    private javax.swing.JPanel panelSelectionBg5;
    ...
    private void setStyleDonateBlood() {
        lblBookApt.setForeground(Color.white);
        lblBookApt.setFont(new Font("Lucida Grande", Font.PLAIN, 20));        
